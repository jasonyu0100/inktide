...
Return JSON:
{
  ...
  "events": ["event_tag"],
  "threadDeltas": [{"threadId": "T-XX", "from": "latent|seeded|active|escalating|critical|resolved|subverted|abandoned", "to": "latent|seeded|active|escalating|critical|resolved|subverted|abandoned", "addedNodes": [{"id": "TK-NEW-001", "matrixCell": "cc|cd|dc|dd", "actorId": "C-XX", "targetId": "C-YY or null", "stance": "cooperative|competitive|neutral", "type": "pulse|transition|setup|escalation|payoff|twist|callback|resistance|stall", "content": "thread-specific: what happened to THIS thread in THIS scene (NOT a scene summary)"}]}],
