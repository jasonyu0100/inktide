...
Return JSON:
{
  ...
  "continuityMutations": [{"entityId": "C-XX", "addedNodes": [{"id": "K-NEW-001", "content": "complete sentence: what they experienced or became", "type": "trait|state|history|capability|belief|relation|secret|goal|weakness"}], "addedEdges": [{"from": "K-NEW-001", "to": "K-XX", "relation": "follows|causes|contradicts|enables"}]}],
