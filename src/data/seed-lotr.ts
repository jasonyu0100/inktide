...
const scenes: Record<string, Scene> = {
  ...
  'S-LOTR-001': {
    ...
    forceSnapshot: { pressure: -0.7, momentum: -0.6, flux: -0.8 },
    prose: '',
  ...
  'S-LOTR-002': {
    ...
    forceSnapshot: { pressure: -0.5, momentum: -0.4, flux: -0.7 },
    prose: '',
  ...
  'S-LOTR-003': {
    ...
    forceSnapshot: { pressure: -0.2, momentum: -0.1, flux: -0.5 },
    prose: '',
  ...
  'S-LOTR-004': {
    ...
    forceSnapshot: { pressure: -0.05, momentum: 0.1, flux: -0.3 },
    prose: '',
  ...
  'S-LOTR-005': {
    ...
    forceSnapshot: { pressure: 0.2, momentum: 0.3, flux: -0.1 },
    prose: '',
  ...
  'S-LOTR-006': {
    ...
    forceSnapshot: { pressure: 0.1, momentum: 0.0, flux: 0.0 },
    prose: '',
  ...
  'S-LOTR-007': {
    ...
    forceSnapshot: { pressure: 0.15, momentum: 0.1, flux: 0.05 },
    prose: '',
  ...
  'S-LOTR-008': {
    ...
    forceSnapshot: { pressure: 0.35, momentum: 0.3, flux: 0.15 },
    prose: '',
  ...
  'S-LOTR-009': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.5, flux: 0.3 },
    prose: '',
  ...
  'S-LOTR-010': {
    ...
    forceSnapshot: { pressure: 0.4, momentum: 0.2, flux: 0.25 },
    prose: '',
  ...
  'S-LOTR-011': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.3, flux: 0.3 },
    prose: '',
  ...
  'S-LOTR-012': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.6, momentum: 0.4, flux: 0.4 },
    prose: '',
  ...
  'S-LOTR-013': {
    ...
    forceSnapshot: { pressure: 0.75, momentum: 0.6, flux: 0.5 },
    prose: '',
  ...
  'S-LOTR-014': {
    ...
    forceSnapshot: { pressure: 0.85, momentum: 0.8, flux: 0.6 },
    prose: '',
  ...
  'S-LOTR-015': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.7, flux: 0.4 },
    prose: '',
...
const altScenes: Record<string, Scene> = {
  'S-LOTR-ALT-011': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.3, flux: 0.2 },
    prose: '',
  ...
  'S-LOTR-ALT-012': {
    ...
    forceSnapshot: { pressure: 0.55, momentum: 0.4, flux: 0.15 },
    prose: '',
  ...
  'S-LOTR-ALT-013': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.6, flux: 0.3 },
    prose: '',
  ...
  'S-LOTR-ALT-014': {
    ...
    forceSnapshot: { pressure: 0.65, momentum: 0.5, flux: 0.2 },
    prose: '',
  ...
  'S-LOTR-ALT-015': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.6, flux: 0.15 },
    prose: '',
...
export const seedLOTR: NarrativeState = {
  ...
  controlMode: 'auto',
  activeForces: { pressure: 0, momentum: 0, flux: 0 },
  createdAt: Date.now() - 86400000,
  updatedAt: Date.now(),
};
