...
const scenes: Record<string, Scene> = {
  ...
  'S-GOT-002': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.6, momentum: -0.5, flux: -0.7 },
    prose: '',
  ...
  'S-GOT-004': {
    ...
    forceSnapshot: { pressure: -0.4, momentum: -0.3, flux: -0.6 },
    prose: '',
  ...
  'S-GOT-005': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.3, momentum: -0.2, flux: -0.5 },
    prose: '',
  ...
  'S-GOT-007': {
    ...
    forceSnapshot: { pressure: -0.1, momentum: 0.0, flux: -0.3 },
    prose: '',
  ...
  'S-GOT-008': {
    ...
    forceSnapshot: { pressure: 0.0, momentum: 0.1, flux: -0.2 },
    prose: '',
  ...
  'S-GOT-009': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.1, momentum: 0.2, flux: -0.1 },
    prose: '',
  ...
  'S-GOT-010': {
    ...
    forceSnapshot: { pressure: 0.3, momentum: 0.3, flux: 0.0 },
    prose: '',
  ...
  'S-GOT-011': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.4, momentum: 0.3, flux: 0.1 },
    prose: '',
  ...
  'S-GOT-012': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.4, flux: 0.2 },
    prose: '',
  ...
  'S-GOT-013': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.5, flux: 0.3 },
    prose: '',
...
const altScenes: Record<string, Scene> = {
  ...
  'S-GOT-ALT-012': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.5, flux: 0.2 },
    prose: '',
  ...
  'S-GOT-ALT-013': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.6, flux: 0.3 },
    prose: '',
