...
import type { NarrativeState, Scene, Arc, Thread, Character, Location, StructureReview, ProseEvaluation, PlanEvaluation } from '@/types/narrative';
...
describe('evaluateBranch', () => {
  it('returns empty result when no scenes', async () => {
    ...
    const result = await evaluateBranch(narrative, [], 'main');
  ...
  it('parses valid evaluation response', async () => {
    ...
    const result = await evaluateBranch(narrative, ['S-001', 'S-002'], 'main');
  ...
  it('handles all verdict types', async () => {
    ...
    const result = await evaluateBranch(narrative, ['S-001', 'S-002', 'S-003', 'S-004', 'S-005'], 'main');
  ...
  it('converts merge to cut when target is invalid', async () => {
    ...
    const result = await evaluateBranch(narrative, ['S-001'], 'main');
  ...
  it('uses streaming when onReasoning callback provided', async () => {
    ...
    const result = await evaluateBranch(narrative, ['S-001'], 'main', undefined, onReasoning);
  ...
  it('includes guidance in prompt when provided', async () => {
    ...
    await evaluateBranch(narrative, ['S-001'], 'main', 'Focus on pacing issues');
  ...
  it('generates unique evaluation ID', async () => {
    ...
    const result1 = await evaluateBranch(narrative, ['S-001'], 'main');
    const result2 = await evaluateBranch(narrative, ['S-001'], 'main');
...
describe('evaluateProseQuality', () => {
  it('returns empty result when no scenes have prose', async () => {
    ...
    const result = await evaluateProseQuality(narrative, ['S-001'], 'main');
  ...
  it('parses valid prose evaluation response', async () => {
    ...
    const result = await evaluateProseQuality(narrative, ['S-001', 'S-002'], 'main');
  ...
  it('includes prose profile in prompt when available', async () => {
    ...
    await evaluateProseQuality(narrative, ['S-001'], 'main');
  ...
  it('uses streaming when onReasoning provided', async () => {
    ...
    await evaluateProseQuality(narrative, ['S-001'], 'main', undefined, onReasoning);
...
describe('evaluatePlanQuality', () => {
  it('returns empty result when no scenes have plans', async () => {
    ...
    const result = await evaluatePlanQuality(narrative, ['S-001'], 'main');
  ...
  it('parses valid plan evaluation response', async () => {
    ...
    const result = await evaluatePlanQuality(narrative, ['S-001', 'S-002'], 'main');
  ...
  it('includes character knowledge in prompt', async () => {
    ...
    await evaluatePlanQuality(narrative, ['S-001'], 'main');
  ...
  it('uses streaming when onReasoning provided', async () => {
    ...
    await evaluatePlanQuality(narrative, ['S-001'], 'main', undefined, onReasoning);
  ...
  it('includes guidance in prompt when provided', async () => {
    ...
    await evaluatePlanQuality(narrative, ['S-001'], 'main', 'Check beat consistency');
