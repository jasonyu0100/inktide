...
9. **Node count**: Target ${nodeCountMin}-${nodeCountMax} nodes across all types. The nudged bands leave room for secondary characters to get their own reasoning chains, not just appear as participants.
