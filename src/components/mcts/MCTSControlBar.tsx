  ...
  return (
    <div className="absolute top-2 left-1/2 -translate-x-1/2 z-20">
      <div className="glass-pill px-3 py-1.5 flex items-center gap-3">
        ...
        <button onClick={onStop} className="w-6 h-6 flex items-center justify-center text-text-dim hover:text-fate hover:bg-white/6 rounded transition-colors" title="Stop">
          <IconStop size={10} />
        </button>
