...
const scenes: Record<string, Scene> = {
  ...
  'S-SW-001': {
    ...
    forceSnapshot: { pressure: -0.5, momentum: -0.3, flux: -0.7 },
    prose: '',
  ...
  'S-SW-002': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.4, momentum: -0.2, flux: -0.6 },
    prose: '',
  ...
  'S-SW-003': {
    ...
    forceSnapshot: { pressure: -0.2, momentum: -0.1, flux: -0.4 },
    prose: '',
  ...
  'S-SW-004': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.0, momentum: 0.1, flux: -0.3 },
    prose: '',
  ...
  'S-SW-005': {
    ...
    forceSnapshot: { pressure: 0.1, momentum: 0.2, flux: -0.2 },
    prose: '',
  ...
  'S-SW-007': {
    ...
    forceSnapshot: { pressure: 0.3, momentum: 0.4, flux: 0.0 },
    prose: '',
  ...
  'S-SW-008': {
    ...
    forceSnapshot: { pressure: 0.4, momentum: 0.5, flux: 0.1 },
    prose: '',
  ...
  'S-SW-009': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.6, flux: 0.2 },
    prose: '',
  ...
  'S-SW-010': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.7, flux: 0.3 },
    prose: '',
  ...
  'S-SW-012': {
    ...
    forceSnapshot: { pressure: 0.8, momentum: 0.8, flux: 0.5 },
    prose: '',
  ...
  'S-SW-013': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.9, momentum: 0.9, flux: 0.6 },
    prose: '',
  ...
  'S-SW-014': {
    ...
    forceSnapshot: { pressure: 1.0, momentum: 1.0, flux: 0.7 },
    prose: '',
  ...
  'S-SW-015': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.8, flux: 0.3 },
    prose: '',
...
const altScenes: Record<string, Scene> = {
  'S-SW-ALT-011': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.5, flux: 0.4 },
    prose: '',
  ...
  'S-SW-ALT-012': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.6, flux: 0.5 },
    prose: '',
  ...
  'S-SW-ALT-013': {
    ...
    forceSnapshot: { pressure: 0.8, momentum: 0.7, flux: 0.6 },
    prose: '',
  ...
  'S-SW-ALT-014': {
    ...
    forceSnapshot: { pressure: 0.95, momentum: 0.9, flux: 0.7 },
    prose: '',
