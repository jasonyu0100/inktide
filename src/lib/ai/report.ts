...
- Focus on the three narrative forces: Fate (thread resolutions), World (character transformation), and System (world-building). Also discuss Delivery (the composite pacing curve).
