  ...
  "scenes": [
    {
      ...
      "threadDeltas": [{"threadId": "T-XX", "from": "...", "to": "...", "addedNodes": [{"id": "TK-GEN-001", "matrixCell": "cc|cd|dc|dd", "actorId": "C-XX", "targetId": "C-YY or null", "stance": "cooperative|competitive|neutral", "type": "pulse|transition|setup|escalation|payoff|twist|callback|resistance|stall", "content": "15-25 words: what happened to THIS thread"}]}],
