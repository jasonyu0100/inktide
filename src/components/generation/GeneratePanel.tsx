            ...
            {mode === 'continuation' ? (
              <>
                ...
                <button
                  onClick={handleSample}
                  disabled={!newArc && !currentArc}
                  className="w-full py-2.5 rounded-lg bg-white/10 hover:bg-white/16 text-text-primary font-semibold transition disabled:opacity-30 flex items-center justify-center gap-2 text-[12px]"
                >
