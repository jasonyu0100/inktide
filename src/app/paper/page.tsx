  ...
  return (
    <div className="my-5 px-3 sm:px-5 py-4 rounded-lg bg-white/3 border border-white/6">
      ...
      <p className="text-[10px] text-white/25 mt-3">
        Structure, planning, reasoning graphs, evaluation &amp; analysis:{" "}
        <span className="text-emerald-500/40">Gemini 2.5 Flash</span> ($0.30/M
        in · $2.50/M out+reasoning). Prose only:{" "}
        <span className="text-amber-500/40">Gemini 3 Flash Preview</span>{" "}
        ($0.50/M in · $3.00/M out+reasoning). Per-arc generation cost is
        roughly constant once the story exceeds the default 50-scene context
        window — both the per-scene plan/prose passes and the per-arc CRG
        operate on bounded slices of the timeline regardless of total length.
      </p>
