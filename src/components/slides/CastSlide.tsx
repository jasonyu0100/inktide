                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="h-1.5 rounded-full bg-white/5 overflow-hidden">
                        <div
                          ...
                          style={{ width: `${maxUsage > 0 ? (a.usageCount / maxUsage) * 100 : 0}%` }}
                        />
                      </div>
                      <div className="flex flex-wrap gap-1 mt-1">
                        <span className="text-[9px] text-text-dim bg-white/5 rounded px-1.5 py-0.5">{owner ?? 'world'}</span>
                        {a.artifact.significance !== 'minor' && (
                          <span className="text-[9px] text-text-dim bg-white/5 rounded px-1.5 py-0.5">{a.artifact.significance}</span>
                        )}
                      </div>
                    </div>
                  </div>
