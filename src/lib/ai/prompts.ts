...
- CHANGE ~4: ~3-4 continuity mutations + ~2-3 events + relationship shifts (valenceDelta ±0.2+).
...
- Include whenever characters interact meaningfully. Feeds Change via √Σ|valenceDelta|.
