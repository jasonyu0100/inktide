/**
 * Structural Rules Prompt — shared text block (used in both system and user
...
export const PROMPT_STRUCTURAL_RULES = `STRUCTURAL RULES — the defaults that protect against filler. These apply across registers: fiction, memoir, essay, reportage, research. "Scene" is the system's internal unit regardless of register. Rules are defaults, not laws — a declared form or prose profile can override them explicitly.
