...
const scenes: Record<string, Scene> = {
  ...
  'S-HP-002': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.6, momentum: -0.3, flux: -0.6 },
    prose: '',
  ...
  'S-HP-003': {
    ...
    forceSnapshot: { pressure: -0.5, momentum: -0.1, flux: -0.5 },
    prose: '',
  ...
  'S-HP-004': {
    ...
    forceSnapshot: { pressure: -0.4, momentum: 0.0, flux: -0.4 },
    prose: '',
  ...
  'S-HP-005': {
    ...
    forceSnapshot: { pressure: -0.3, momentum: 0.1, flux: -0.3 },
    prose: '',
  ...
  'S-HP-006': {
    ...
    forceSnapshot: { pressure: -0.2, momentum: 0.0, flux: -0.3 },
    prose: '',
  ...
  'S-HP-007': {
    ...
    forceSnapshot: { pressure: -0.1, momentum: 0.1, flux: -0.1 },
    prose: '',
  ...
  'S-HP-008': {
    ...
    forceSnapshot: { pressure: 0.0, momentum: 0.2, flux: 0.0 },
    prose: '',
  ...
  'S-HP-009': {
    ...
    forceSnapshot: { pressure: 0.1, momentum: 0.3, flux: 0.1 },
    prose: '',
  ...
  'S-HP-010': {
    ...
    forceSnapshot: { pressure: 0.2, momentum: 0.2, flux: 0.2 },
    prose: '',
  ...
  'S-HP-011': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.3, momentum: 0.2, flux: 0.3 },
    prose: '',
  ...
  'S-HP-012': {
    ...
    forceSnapshot: { pressure: 0.5, momentum: 0.4, flux: 0.3 },
    prose: '',
  ...
  'S-HP-014': {
    ...
    forceSnapshot: { pressure: 0.9, momentum: 0.8, flux: 0.5 },
    prose: '',
  ...
  'S-HP-015': {
    ...
    forceSnapshot: { pressure: 0.8, momentum: 0.7, flux: 0.4 },
    prose: '',
...
const altScenes: Record<string, Scene> = {
  'S-HP-ALT-006': {
    ...
    forceSnapshot: { pressure: -0.2, momentum: 0.0, flux: 0.2 },
    prose: '',
  ...
  'S-HP-ALT-007': {
    ...
    forceSnapshot: { pressure: -0.1, momentum: 0.1, flux: 0.3 },
    prose: '',
  ...
  'S-HP-ALT-008': {
    ...
    forceSnapshot: { pressure: 0.0, momentum: 0.2, flux: 0.4 },
    prose: '',
  ...
  'S-HP-ALT-009': {
    ...
    forceSnapshot: { pressure: 0.1, momentum: 0.3, flux: 0.5 },
    prose: '',
  ...
  'S-HP-ALT-010': {
    ...
    forceSnapshot: { pressure: 0.2, momentum: 0.3, flux: 0.6 },
    prose: '',
