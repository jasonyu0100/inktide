...
- **Iterative revision** — evaluate branches by summary → per-scene verdicts (ok/edit/rewrite/cut) → reconstruct versioned branches
...
- **BranchEvaluation** — per-scene verdicts (ok/edit/rewrite/cut), overall critique, repetition patterns, thematic question
...
- **edit** — tighten summary/events/mutations within locked POV/location/cast
- **rewrite** — rebuild scene structure from scratch
