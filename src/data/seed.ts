...
const scenes: Record<string, Scene> = {
  ...
  'S-002': {
    ...
    forceSnapshot: { pressure: -0.6, momentum: -0.5, flux: -0.8 },
    prose: '',
  ...
  'S-003': {
    ...
    forceSnapshot: { pressure: -0.44, momentum: -0.3, flux: -0.76 },
    prose: '',
  ...
  'S-004': {
    ...
    forceSnapshot: { pressure: -0.4, momentum: -0.24, flux: -0.74 },
    prose: '',
  ...
  'S-005': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.3, momentum: -0.1, flux: -0.7 },
    prose: '',
  ...
  'S-006': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.24, momentum: -0.16, flux: -0.68 },
    prose: '',
  ...
  'S-007': {
    ...
    forceSnapshot: { pressure: -0.1, momentum: -0.24, flux: -0.6 },
    prose: '',
  ...
  'S-008': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: -0.04, momentum: -0.28, flux: -0.44 },
    prose: '',
  ...
  'S-009': {
    ...
    forceSnapshot: { pressure: 0.0, momentum: -0.32, flux: -0.4 },
    prose: '',
  ...
  'S-010': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.1, momentum: -0.3, flux: -0.3 },
    prose: '',
  ...
  'S-012': {
    ...
    knowledgeMutations: [],
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.3, momentum: 0.1, flux: -0.1 },
    prose: '',
  ...
  'S-013': {
    ...
    relationshipMutations: [],
    forceSnapshot: { pressure: 0.44, momentum: 0.3, flux: 0.0 },
    prose: '',
  ...
  'S-014': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.5, flux: 0.1 },
    prose: '',
  ...
  'S-015': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.6, flux: 0.2 },
    prose: '',
...
const altScenes: Record<string, Scene> = {
  ...
  'S-ALT-012': {
    ...
    forceSnapshot: { pressure: 0.4, momentum: 0.1, flux: 0.0 },
    prose: '',
  ...
  'S-ALT-013': {
    ...
    forceSnapshot: { pressure: 0.6, momentum: 0.4, flux: 0.1 },
    prose: '',
  ...
  'S-ALT-014': {
    ...
    forceSnapshot: { pressure: 0.8, momentum: 0.6, flux: 0.3 },
    prose: '',
  ...
  'S-ALT-015': {
    ...
    forceSnapshot: { pressure: 0.7, momentum: 0.7, flux: 0.2 },
    prose: '',
